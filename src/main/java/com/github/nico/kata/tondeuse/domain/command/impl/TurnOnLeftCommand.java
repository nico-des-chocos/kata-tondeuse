...
public class TurnOnLeftCommand implements LawnmowerCommand {
    @Override
    public Lawnmower doMove(Lawnmower lawnmower) {
        Coordinates pos = lawnmower.getCoordinates();
        switch (lawnmower.getOrientation()) {
            case NORTH: lawnmower.updateState(pos, Orientation.WEST);break;
            case WEST: lawnmower.updateState(pos, Orientation.SOUTH);break;
            case SOUTH: lawnmower.updateState(pos, Orientation.EAST);break;
            case EAST: lawnmower.updateState(pos, Orientation.NORTH);break;
        }
